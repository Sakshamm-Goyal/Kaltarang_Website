...
const Merch = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-grid p-6">
      <div className="text-center text-black text-2xl font-granular" style={{ fontFamily: 'Press Start 2P, sans-serif' }}>
        <span className="text-blue-600 font-granular">GRAB</span> YOURSELF <span className="underline">___</span>
        <br /> A <span className="text-blue-600 font-granular">PIECE</span> OF KALTARANG
      </div>
